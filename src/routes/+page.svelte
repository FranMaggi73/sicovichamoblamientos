<script lang="ts">
  ...
  pageTitle.set('Sicovichamoblamientos');
...
<main class="flex-1 flex flex-col sm:pb-20 w-full overflow-x-auto">
  ...
  <div class="divider m-0 p-0 mt-8" />
  <footer class="footer footer-horizontal footer-center bg-base-300 text-neutral p-8">
    <aside>
      <svg
        width="50"
        height="50"
      ...
      <p class="font-bold">Sicovichamoblamientos</p>
    </aside>
    <nav>
